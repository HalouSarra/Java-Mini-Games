package minigames.pacman.v1_tutorial_reference;
...
public class PacMan extends JPanel implements ActionListener, KeyListener{
    class Block{
        ...
        void updateVelocity(){
            if(this.direction == 'U'){ // go up 8 pixels in every frame!
                this.velocityX = 0;
    ...
    PacMan(){
        ...
        addKeyListener(this);
        setFocusable(true); //make sure the JPanel is the one listening for key presses
    ...
    @Override
    public void keyTyped(KeyEvent e) {}//for keys with characters like 'A'

    @Override
    public void keyPressed(KeyEvent e) {} // for any pressed key, we can even hold onto the key

    @Override
    public void keyReleased(KeyEvent e) { // same as the previous but it only triggers this function if we press a key, and we let go, and we release the key
        if(gameOver){
            loadMap();
            resetPositions();
            lives = 3;
